...
namespace PruebaTecnica.Controllers
{
    public class VentaController : Controller
    {
        ...
        public JsonResult VentaInsertar([FromBody] clsVentaConDetalle ventaConDetalle)
        {
            clsVenta objVentas = ventaConDetalle.objVentas;
            clsListaDetalleVenta objDetalleVentas = ventaConDetalle.objDetalleVentas;
            // Comprobación de datos recibidos
